...
num_args = 2 # including the script name

def print_usage():
    print "Usage: python ", sys.argv[0], "<grav_pos split>"
    print "Where the number of splits is concatenated to the grav_pos file (e.g. grav_pos_500.txt)."
    sys.exit(1)
